...
Als Nächstes folgen Layout-/Autoscroll-Steuerung und die weiteren Container-Bedienfälle, Zwischenablage, allgemeinere Zustandsfolgen und tatsächliche Binding-Messung. Die Browserabnahme wartet weiter auf die bereits erfragte explizite Freigabe gemäß `AGENTS.md`. Das ist keine Sperre für diese unabhängigen Code- und Komponentenschritte.
