...
Die nächste abgeschlossene Einheit behandelt die gemeinsamen Verschiebebefehle; danach folgen die genannten Blocksteuerungs-/Layoutlücken, Zwischenablage, allgemeinere Zustandsfolgen und tatsächliche Binding-Messung. Die Browserabnahme wartet weiter auf die bereits erfragte explizite Freigabe gemäß `AGENTS.md`. Das ist keine Sperre für diese unabhängigen Code- und Komponentenschritte.
