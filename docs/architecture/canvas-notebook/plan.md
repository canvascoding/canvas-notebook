...
- `postgres-only-cli-installation-plan.md`: schrittweiser Migrationsplan fuer PostgreSQL-only Fresh Installs mit lokal verwaltetem oder extern gehostetem PostgreSQL, sicherer URL-Eingabe, Verbindungs-/pgvector-Preflight, Bestands-SQLite-Kompatibilitaet sowie Control-Plane-/Agent-Anpassungen.
