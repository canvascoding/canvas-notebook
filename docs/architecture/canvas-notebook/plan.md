...
- `electron-workspace-drive-plan.md`: geplanter bidirektionaler, lokaler Workspace-Drive fuer Electron mit Delta-Sync, Konflikt-, Root-Schutz- und Offline-Policy sowie einer modularen, spaeter mount-faehigen Architektur.
