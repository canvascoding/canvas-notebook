...
- `team-workspace/22-excalidraw-live-collaboration-policy.md`: separate Zielarchitektur fuer echte Excalidraw-Multi-User-Bearbeitung mit offiziellem elementweisen Reconciliation-Modell, Canvas-Auth/Presence/Postgres/Checkpoints, Asset-Pipeline und vorgeschaltetem Architektur-Spike.
