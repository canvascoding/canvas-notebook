...
This project is indexed by GitNexus as **canvas-notebook** (29635 symbols, 79894 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
