---
name: brave-search
description: Web search and page content extraction via Brave Search API. Use for searching documentation, facts, current events, or any web content. Lightweight, no browser required. Requires BRAVE_API_KEY in Canvas Integrations settings.
---
