...
Use this only when the DOCX workflow needs LibreOffice conversion or rendering.
...
- Put converted files and all render output below `CANVAS_AGENT_TEMP_DIR`; never write workspace files through `soffice`.
