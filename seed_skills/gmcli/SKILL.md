---
name: gmcli
description: "Gmail CLI for searching emails, reading threads, sending messages, managing drafts, and handling labels/attachments. Triggers: Gmail, send email, search email, read email, email thread, email draft, email labels, gmcli."
compatibility: Requires Google OAuth credentials configured via gmcli setup
allowed-tools: Bash(gmcli:*)
metadata:
  version: "1.0"
