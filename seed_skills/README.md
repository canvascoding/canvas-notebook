...
Dieses Verzeichnis enthält die Seed-Skills, die beim Container-Start nach `/data/skills/` kopiert werden. Skills sind lokale CLI-Werkzeuge, die der Agent über das `bash`-Tool aufrufen kann.
