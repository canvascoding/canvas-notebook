---
name: gdcli
description: "Google Drive CLI for listing, searching, uploading, downloading, and sharing files and folders. Triggers: Google Drive, upload to Drive, download from Drive, share Drive file, find file on Drive, Drive folder, Drive search, gdcli."
compatibility: Requires Google OAuth credentials configured via gdcli setup
allowed-tools: Bash(gdcli:*)
metadata:
  version: "1.0"
