...
import { AUTOMATION_APP_URI, TODO_APP_URI, PUBLIC_SHARE_APP_URI, type BuiltinToolAppDescriptor } from './types';
...
export async function readBuiltinToolAppResource(app: BuiltinToolAppDescriptor): Promise<string> {
  const artifact = { [AUTOMATION_APP_URI]: 'automation-job-v1.html', [TODO_APP_URI]: 'human-todo-v1.html', [PUBLIC_SHARE_APP_URI]: 'public-share-v1.html' }[app.resourceUri];
