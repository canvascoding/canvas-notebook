export const STUDIO_STARTING_POINTS = [
  {
  ...
  },
  {
    id: 'sp-brand-sound',
    title: 'Brand Sound',
    description: 'A concise sonic identity for an intro, reveal, or campaign moment.',
    category: 'Sound',
    prompt: 'Distinctive premium brand sound, memorable melodic motif, polished modern production, cinematic reveal, clean ending',
    suggestedMode: 'sound',
  },
  {
