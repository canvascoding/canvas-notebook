...
export function buildEmailComposeAgentSystemPrompt(input: EmailComposeAgentInput): string {
  return [
    ...
    '- Use normal email-safe structure: <p>, <br>, <strong>, <em>, <s>, <ul>, <ol>, <li>, <a>, and <blockquote> only.',
    '- Do not use scripts, stylesheets, forms, iframes, images, tables, markdown, code fences, or wrapper tags like <html>, <head>, or <body>.',
