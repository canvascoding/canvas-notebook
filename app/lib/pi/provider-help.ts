...
export const PROVIDER_HELP: Record<string, ProviderHelpInfo> = {
  ...
  ollama: {
    category: 'ollama',
    title: 'Ollama',
    shortDescription: 'Local LLM inference with Ollama',
    setupSteps: [
      'Install Ollama from https://ollama.ai/',
      'Pull your desired model: ollama pull llama3.2',
      'Ensure Ollama is running',
      'Verify the provider status',
    ],
    cliCommands: [
      { command: 'ollama pull llama3.2', description: 'Download a model' },
    ...
    notes: [
      ...
      'Requires sufficient local resources (RAM/VRAM)',
