...
const TOOLSET_TOOL_NAMES: Record<PiToolset, Set<string>> = {
  ...
  file: new Set(['apply_patch', 'copy_path', 'delete_path', 'edit_file', 'glob', 'grep', 'inspect_document_relations', 'list_file_snapshots', 'ls', 'move_path', 'public_share_file', 'read', 'restore_file_snapshot', 'rg', 'write']),
