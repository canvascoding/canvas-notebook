...
export function createStudioGenerateImageTool(
  ...
  return {
    ...
    parameters: Type.Object({
      ...
      model: Type.Optional(Type.String({ description: 'Model ID. Only two options: gemini-3.1-flash-image-preview (when provider is gemini) or gpt-image-2 (when provider is openai). If omitted, defaults to the best model for the selected provider.' })),
