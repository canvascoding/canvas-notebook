...
export function createStudioGenerateImageTool(
  ...
  return {
    ...
    parameters: Type.Object({
      ...
      model: Type.Optional(Type.String({ description: 'Model ID. Options: gemini-3.1-flash-image (default, best quality & features), gemini-3-pro-image (pro quality & reasoning, Nano Banana Pro), gpt-image-2.5-sunburst (when provider is openai). If omitted, defaults to the best model for the selected provider.' })),
