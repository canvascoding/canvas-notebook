...
export function createStudioGenerateImageTool(
  ...
  return {
    ...
    parameters: Type.Object({
      ...
      image_size: Type.Optional(Type.String({ description: 'Image resolution. Gemini: "512" (only gemini-3.1-flash), "1K", "2K", or "4K". OpenAI: "auto" or WIDTHxHEIGHT; both edges must be multiples of 16, at most 3840px, aspect ratio at most 3:1, and total pixels between 655,360 and 8,294,400.' })),
