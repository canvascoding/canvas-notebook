...
const TOOL_DISPLAY: Record<string, ToolDisplayEntry> = {
  ...
  email_create_outbox_draft: { label: 'Created Outbox draft', labelDe: 'Outbox-Entwurf erstellt', tone: 'emailDraftCreate' },
  email_update_outbox_draft: { label: 'Updated Outbox draft', labelDe: 'Outbox-Entwurf aktualisiert', tone: 'emailDraftUpdate' },
  email_list_outbox_drafts: { label: 'Loaded Outbox drafts', labelDe: 'Outbox-Entwürfe geladen', tone: 'emailAccounts' },
  ...
  update_human_todo: { label: 'Updated human to-do', labelDe: 'To-do für Menschen aktualisiert', tone: 'todo' },
  public_share_file: { label: 'Managed public file link', labelDe: 'Öffentlichen Datei-Link verwaltet', tone: 'publicShare' },
  pdf: { label: 'Used PDF gateway', labelDe: 'PDF-Gateway verwendet', tone: 'file' },
  create_pdf: { label: 'Created a PDF', labelDe: 'PDF erstellt', tone: 'fileCreate' },
  pdf_to_markdown: { label: 'Converted PDF to Markdown', labelDe: 'PDF in Markdown umgewandelt', tone: 'fileCreate' },
  split_pdf: { label: 'Split a PDF', labelDe: 'PDF aufgeteilt', tone: 'fileCreate' },
  edit_pdf_pages: { label: 'Edited PDF pages', labelDe: 'PDF-Seiten bearbeitet', tone: 'fileCreate' },
