...
- Use only exact absolute file paths that were returned by a trusted tool result, such as files under the active workspace's /data/studio/organizations/.../workspaces/... directory, /data/user-uploads, or the normal active workspace.
