...
function translateProviderHelpText(text: string, locale: string): string {
  ...
  const exactMatches: Record<string, string> = {
    ...
    'Open the authorization URL in your browser': 'Öffne die Autorisierungs-URL in deinem Browser',
    'Copy the authorization code and paste it in the dialog': 'Kopiere den Autorisierungscode und füge ihn in den Dialog ein',
    'Click "Complete Connection" to finish': 'Klicke auf "Verbindung abschließen", um den Vorgang zu beenden',
    ...
    'Multiple authentication methods supported': 'Mehrere Authentifizierungsmethoden werden unterstützt',
