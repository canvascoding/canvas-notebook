...
for (const [entry, title] of [['automation-job', 'Canvas Automation'], ['human-todo', 'Canvas Todo'], ['public-share', 'Canvas Public Link'], ['file-change-group', 'Canvas File Changes']]) {
